...
namespace Session04.DAL.Migrations
{
    ...
    [Migration("20260611003411_Intial Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Session04.DAL.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("Session04.DAL.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Session04.DAL.Models.HealthRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Session04.DAL.Models.Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Session04.DAL.Models.MemberShip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Session04.DAL.Models.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Session04.DAL.Models.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Session04.DAL.Models.Trainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Session04.DAL.Models.Booking", b =>
                {
                    b.HasOne("Session04.DAL.Models.Member", "Member")
                        .WithMany("MemberSessions")
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Session04.DAL.Models.Session", "Session")
            ...
            modelBuilder.Entity("Session04.DAL.Models.HealthRecord", b =>
                {
                    b.HasOne("Session04.DAL.Models.Member", "Member")
                        ...
                        .HasForeignKey("Session04.DAL.Models.HealthRecord", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Session04.DAL.Models.Member", b =>
                {
                    b.OwnsOne("Session04.DAL.Models.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("Session04.DAL.Models.MemberShip", b =>
                {
                    ...
                    b.HasOne("Session04.DAL.Models.Plan", "Plan")
            ...
            modelBuilder.Entity("Session04.DAL.Models.Session", b =>
                {
                    b.HasOne("Session04.DAL.Models.Category", "Category")
                        .WithMany("Sessions")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Session04.DAL.Models.Trainer", "Trainer")
                        .WithMany("Sessions")
